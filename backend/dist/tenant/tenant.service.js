...
let TenantService = class TenantService {
    ...
    async createTenant(dto) {
        if (!/^[a-z0-9]+$/.test(dto.subdomain)) {
            throw new common_1.BadRequestException('Subdomain must be lowercase alphanumeric only');
        }
        ...
        try {
            ...
            throw new common_1.InternalServerErrorException(`Failed to create tenant: ${e?.message || 'Unknown error'}`);
        }
    }
