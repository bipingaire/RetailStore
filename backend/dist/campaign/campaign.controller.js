...
let CampaignController = class CampaignController {
    ...
    async getActiveCampaigns(tenantId) {
    ...
    async partialUpdate(tenantId, id, body) {
        return this.campaignService.updateCampaign(tenantId, id, body);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CampaignController.prototype, "getActivePromotions", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], CampaignController.prototype, "partialUpdate", null);
__decorate([
