...
import { Search, ChevronDown, ChevronUp, FileText, Receipt } from 'lucide-react';
                                ...
                                return (
                                    <>
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-sm text-gray-600">{inv.invoice_date ? new Date(inv.invoice_date).toLocaleDateString() : 'N/A'}</td>
